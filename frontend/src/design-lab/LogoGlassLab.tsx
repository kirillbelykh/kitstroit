...
export default function LogoGlassLab() {
  ...
  return (
    <main className={`logo-glass-lab logo-glass-lab--${theme}`}>
      <header className="logo-glass-lab__top">
        <a className="logo-glass-lab__back" href="/">
          ← на сайт
        </a>
        <p className="logo-glass-lab__badge">/test · experimental · production logo не изменён</p>
      </header>

      <div className="logo-glass-lab__intro">
        <h1>Preview: glass-знак K|I|T</h1>
        <p>
          Страница /test — experimental test design. Выбранный вариант — плитки K|I|T
          (mark-kit): Hero и имитация шапки. Production Header и логотип сайта не затронуты.
        </p>
