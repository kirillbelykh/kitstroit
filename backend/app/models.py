...
class Lead(TimestampMixin, Base):
    ...
    ym_client_id: Mapped[str | None] = mapped_column(String(64))
    ...
    first_utm_source: Mapped[str | None] = mapped_column(String(200))
    first_utm_medium: Mapped[str | None] = mapped_column(String(200))
    first_utm_campaign: Mapped[str | None] = mapped_column(String(200))
    first_utm_content: Mapped[str | None] = mapped_column(String(200))
    first_utm_term: Mapped[str | None] = mapped_column(String(200))
